...
<br>
 <input class="submit" id="button" type="button" onclick="getLocationDetails()"  value="getGeoValue"/> 
<form method="post" action="register2.jsp" onsubmit="getLocationDetails()">
...
<input type="text" name="city"  id="city" required placeholder="city" readonly>
<input type="text" name="state"  id="state"  placeholder="state" required readonly>
<input type="text" name="zip"  id="zip"  placeholder="zip" required readonly>
